...
class MainSite2 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      Shared: false,
  ...
  render() {
    const imagesrc = this.props.navigation.getParam('imagesrc');
        ...
        <Card
          ...
          <View style={{flexDirection: 'row'}}>
            ...
            <Button
              ...
              icon={
                <Icon
                  name = {this.state.pressedFav5?'favorite': 'favorite-border'}
                  color='red'/>
              }
              title = {this.state.pressedFav5?'1': '0'}
              buttonStyle = {{marginLeft: 5}}
              onPress = {() => {this.setState({pressedFav5: !this.state.pressedFav5})}}/>

            <Button
              type = 'clear'
              icon={
                <Icon
                  name = {this.state.pressedSad5?'favorite': 'favorite-border'}
                  color='yellow'/>
              }
              title = {this.state.pressedSad5?'1': '0'}
              buttonStyle = {{marginLeft: 5}}
              onPress = {() => {this.setState({pressedSad5: !this.state.pressedSad5})}}/>

            <Button
              type = 'clear'
              icon={
                <Icon
                  name = {this.state.pressedPray5?'favorite': 'favorite-border'}
                  color='green'/>
              }
              title = {this.state.pressedPray5?'1': '0'}
              buttonStyle = {{marginLeft: 5}}
              onPress = {() => {this.setState({pressedPray5: !this.state.pressedPray5})}}/>
            </View>
          </View>
        </Card>
